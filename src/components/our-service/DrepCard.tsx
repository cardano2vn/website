      ...
      <div className="relative p-6 sm:p-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <button type="button" onClick={() => onCopy(drepId)} title="Copy DRep ID"
          ...
          <div className="min-w-0">
            ...
            <div className="mt-1 text-2xl font-semibold text-gray-900 dark:text-white whitespace-nowrap">{renderVotingPower()}</div>
          </div>
        </div>
        <div className="mt-6">
